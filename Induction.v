...
Both are used to perform case analysis on an element of an inductively defined type; induction also generates an induction hypothesis, while destruct does not.
(* FILL IN HERE *)
...
Theorem plus_n_nm: forall n m: nat,
n + n * m = n * S m.
Proof.
  intros.
  induction n.
